...
@section('konten')
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="card">
        <form class="form-horizontal" action="{{ url('laporan_penjualan') }}" method="get">
          {{ csrf_field() }}
          <div class="card-body">
            ...
            @if(@$data!=null)
            <a style="float: right;" target="_blank" href="{{ url('laporan_penjualan/excel?dari_tanggal=').@$_GET['dari_tanggal'].'&sampai_tanggal='.@$_GET['sampai_tanggal'] }}" class="btn btn-sm btn-success text-white">Export Excel</a>
